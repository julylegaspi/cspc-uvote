<div>
    <div class="mb-4 items-center justify-between block sm:flex md:divide-x md:divide-gray-100 dark:divide-gray-700">
        <div class="flex items-center mb-4 sm:mb-0">
            <label for="organization-search" class="sr-only">Search</label>
            <div class="relative w-48 mt-1 sm:w-64 xl:w-96">
                <input type="text" id="organization-search"
                    class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                    placeholder="Search organization" wire:model.live.debounce.150ms="query" wire:keydown='search'>
            </div>
        </div>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                            @forelse ($organizations as $organization)
                                <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                    ...
                                    <td
                                        class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        @if (is_null($organization->photo))
                                            N/A
                                        @else
                                            <img class="w-10 h-10 rounded-full"
                                                src="{{ asset('storage/' . $organization->photo) }}" alt="Logo">
                                        @endif

                                    </td>

                                    <td class="p-4 space-x-2 whitespace-nowrap">
                                        <button type="button" wire:click="edit('{{ $organization->id }}')"
                                            ...
                                            <button type="submit" id="deleteOrganization"
                                                wire:click="destroy('{{ $organization->id }}')"
                                                onclick="return confirm('You are about to delete organization. Continue?') || event.stopImmediatePropagation()"
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="p-4 md:p-5 space-y-4">
                    ...
                    <div class="mb-6">
                        ...
                        @if ($logo != null)
                            <img class="h-32 w-32 rounded mb-3" src="{{ asset('storage/' . $logo) }}"
