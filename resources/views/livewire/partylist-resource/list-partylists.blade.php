<div>
    <div class="mb-4 items-center justify-between block sm:flex md:divide-x md:divide-gray-100 dark:divide-gray-700">
        <div class="flex items-center mb-4 sm:mb-0">
            <label for="partylist-search" class="sr-only">Search</label>
            <div class="relative w-48 mt-1 sm:w-64 xl:w-96">
                <input type="text" id="partylist-search"
                    class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                    placeholder="Search partylist" wire:model.live.debounce.150ms="query" wire:keydown='search'>
            </div>
        </div>
                                    ...
                                    <td
                                        ...
                                        @else
                                            <img class="w-10 h-10 rounded-full"
                                                src="{{ asset('storage/' . $partylist->photo) }}" alt="Logo">
                                        @endif
                                    </td>

                                    <td class="p-4 space-x-2 whitespace-nowrap">
                                        <button type="button" wire:click="edit('{{ $partylist->id }}')"
                                        ...
                                        <button type="submit" id="deletePartylist"
                                            wire:click="destroy('{{ $partylist->id }}')"
                                            onclick="return confirm('You are about to delete partylist. Continue?') || event.stopImmediatePropagation()"
